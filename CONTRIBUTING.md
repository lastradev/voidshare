...
- Make sure to check if an [issue exists](https://github.com/lastra-dev/void-share/issues) already & see if the issue is assigned to anyone or not.
...
Once your PR is merged, you will be proudly listed as a contributor in the [contributor chart](https://github.com/lastra-dev/void-share/graphs/contributors).
